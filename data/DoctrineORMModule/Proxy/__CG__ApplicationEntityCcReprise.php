 ...
 */
class CcReprise extends \Application\Entity\CcReprise implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Application\\Entity\\CcReprise' . "\0" . 'id', '' . "\0" . 'Application\\Entity\\CcReprise' . "\0" . 'name', '' . "\0" . 'Application\\Entity\\CcReprise' . "\0" . 'longName', '' . "\0" . 'Application\\Entity\\CcReprise' . "\0" . 'reglement', '' . "\0" . 'Application\\Entity\\CcReprise' . "\0" . 'type', '' . "\0" . 'Application\\Entity\\CcReprise' . "\0" . 'annee', '' . "\0" . 'Application\\Entity\\CcReprise' . "\0" . 'duree', '' . "\0" . 'Application\\Entity\\CcReprise' . "\0" . 'categorie', '' . "\0" . 'Application\\Entity\\CcReprise' . "\0" . 'movements');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CcReprise $proxy) {
    ...
    public function getMovements()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getMovements', array());
